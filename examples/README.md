...
| [`02_catching_hallucinations.py`](02_catching_hallucinations.py) | All eight lexical detectors firing — and which ones webR deliberately refuses to treat as guilt |
